...
namespace InazumaSearch.Core
{
    ...
    public partial class Application
    {
        ...
        public virtual bool Boot()
        {
            ...
            if (!firstBoot && (UserSettings.LastBootVersion == null || UserSettings.LastBootVersion != null && UserSettings.LastBootVersion.ComparePrecedenceTo(new SemVersion(0, 21, 0)) <= 0))
            {
