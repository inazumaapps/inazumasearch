    ...
    public partial class Application
    {
        ...
        public virtual string ThumbnailDirPath
        {
            get
            {
                ...
                {
                    return Path.Combine(System.Environment.GetFolderPath(System.Environment.SpecialFolder.LocalApplicationData), @"Inazuma Search\thumbnail");
                }
            }
        }
        /// <summary>
        ...
        public virtual string LogDirPath
        {
            get
            {
                ...
                {
                    return Path.Combine(System.Environment.GetFolderPath(System.Environment.SpecialFolder.LocalApplicationData), @"Inazuma Search\log");
                }
            }
        }
        ...
        public virtual string UserSettingDirPath
        {
            get
            {
                ...
                {
                    return Path.Combine(System.Environment.GetFolderPath(System.Environment.SpecialFolder.LocalApplicationData), @"Inazuma Search");
                }
            }
        }
